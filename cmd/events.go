...
func init() {
	...
	triggerCmd.Flags().IntVar(&charityCurrentValue, "charity-current-value", 0, "Manually set the current dollar value for charity events")
	triggerCmd.Flags().IntVar(&charityTargetValue, "charity-target-value", 1500000, "Manually set the current dollar value for charity events")
